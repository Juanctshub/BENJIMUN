        ...
        {stage === 'content' && (
          ...
          >
            ...
            <div className="max-w-5xl w-full px-6 md:px-0 space-y-16 md:space-y-20 relative z-10 pt-12 md:pt-0">
               ...
               >
                 {[1, 2, 3, 4].map((num) => (
                    <div key={num} className="relative group overflow-hidden rounded-[2rem] h-[40vh] md:h-auto min-w-[75vw] sm:min-w-[50vw] md:min-w-0 md:aspect-[3/4] glass border-white/5 snap-center shrink-0 shadow-2xl">
                       <img 
                          src={`/assets/${num}.jpg`}
                          ...
                          className="w-full h-full object-cover object-[50%_15%] md:object-center transition-transform duration-1000 md:group-hover:scale-110 filter md:grayscale md:group-hover:grayscale-0"
                       />
